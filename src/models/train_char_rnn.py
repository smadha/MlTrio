...
X,y = pickle.load(open("../feature_engg/feature/char_features.p", "r") ), pickle.load(open("../feature_engg/feature/labels.p", "r") )
...
model.save("./model/rnn_char.h5", overwrite=True)
